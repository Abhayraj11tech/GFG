<h2><a href="https://www.geeksforgeeks.org/problems/smallest-k-digit-number-divisible-by-x2351/1?page=3&category=Mathematical&difficulty=Basic&status=unsolved&sortBy=submissions">Smallest K digit number divisible by X</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given two integers <strong>X </strong>and <strong>K</strong>. The task is to find smallest K-digit number divisible by X.<br>

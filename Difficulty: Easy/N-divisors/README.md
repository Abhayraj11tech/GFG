<h2><a href="https://www.geeksforgeeks.org/problems/n-divisors5123/1?page=4&category=Mathematical&difficulty=Easy&status=unsolved&sortBy=submissions">N-divisors</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:20px">Given three integers A, B, N. Your task is to print the number of numbers between A and B including them,&nbsp;which have N-divisors. A number is called N-divisor if it has total N divisors including 1 and itself.</span><br>
&nbsp;</p>
